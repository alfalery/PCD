...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        #MORFOLOGI
        self.actiondelasi_2.triggered.connect(self.delasi)
        self.actionopening_2.triggered.connect(self.opening)
        self.actionclosing_2.triggered.connect(self.closing)
        self.actionerosi_2.triggered.connect(self.erosi)
