...
class ShowImage(QMainWindow):
    ...
    def skala2x(self):
        self.zoomin(2,'Zoom In 2X')

    def skala3x(self):
        self.zoomin(3,'Zoom In 3X')

    def skala4x(self):
        self.zoomin(4,'Zoom In 4X')
    ...
    def skalasetengah(self):
        self.zoomout(0,5,'Zoom out 1/2')

    def skalaseperempat(self):
        self.zoomout(0,25,'Zoom out 1/4')

    def skalatigaperempat(self):
        self.zoomout(0,75,'Zoom out 3/4')
