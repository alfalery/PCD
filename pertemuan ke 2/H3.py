...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        self.actionToZero_Invers.triggered.connect(self.invtozero)

        #LOCAL
        self.actionMeanT.triggered.connect(self.meanT)
        self.actionGaussianT_2.triggered.connect(self.gaussianT)
        self.actionOtsuT.triggered.connect(self.otsuT)

        #contur
        self.actionIdentifikasiBentuk.triggered.connect(self.countour)
