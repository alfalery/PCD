...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        self.actionsharpI.triggered.connect(self.sharpeningI)
        self.actionsharpII.triggered.connect(self.sharpeningII)
        self.actionsharpIII.triggered.connect(self.sharpeningIII)
        self.actionsharpIV.triggered.connect(self.sharpeningIV)
        self.actionsharpV.triggered.connect(self.sharpeningV)
        self.actionsharpVI.triggered.connect(self.sharpeningVI)




    def fungsi(self):
        self.Image = cv2.imread('matahari.jpg')
        self.displayImage()
